...
class SourceResourceTest extends ResourceTestCase
{
    ...
    public function test_user_can_create_resource_record()
    {
        ...
        $this->postJson($this->createEndpoint(), ['name' => 'Source Name'])
            ->assertStatus(201)
            ->assertJson(['name' => 'Source Name']);
    }

    public function test_unauthorized_user_cannot_create_resource_record()
    {
        $this->asRegularUser()->signIn();
        $this->postJson($this->createEndpoint(), ['name' => 'Source Name'])->assertForbidden();
    }
    ...
    public function test_source_requires_name()
    {
        $this->signIn();
    ...
    public function test_source_name_must_be_unique()
    {
        $this->signIn();
