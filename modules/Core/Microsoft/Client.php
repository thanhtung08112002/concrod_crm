...
namespace Modules\Core\Microsoft;

use Illuminate\Contracts\Support\Arrayable;
use Microsoft\Graph\Graph;
use Microsoft\Graph\Http\GraphCollectionRequest;
use Modules\Core\Microsoft\Services\Batch\BatchRequests;
use Modules\Core\Microsoft\Services\Batch\Request as BatchRequest;
...
class Client
{
     ...
     *
     *
     * @return \Modules\Core\Microsoft\Services\Batch\Request
     */
    ...
    {
        if ($preferredTimezone = config('core.microsoft.prefer_timezone')) {
