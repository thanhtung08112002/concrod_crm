<template>
  <div class="table-responsive">
    <div
      class="overflow-hidden border border-neutral-200 dark:border-neutral-800 sm:rounded-md"
    >
      <table
                  ...
                  <td :colspan="hasTax ? 7 : 6">
                    ...
                    >
                      ...
                      <IFormTextarea
                        rows="2"
                        ref="productNoteRef"
                        class="rounded border border-warning-300 bg-warning-100 dark:bg-warning-200 dark:text-neutral-800"
                        :bordered="false"
                        :rounded="false"
...
function updateProductsOrder() {
  localProducts.value.forEach(
    (product, index) => (localProducts.value[index].display_order = index + 1)
  )
}
