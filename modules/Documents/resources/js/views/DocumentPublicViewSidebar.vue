<template>
  <div>
                  ...
                  <a
                    ...
                    :class="[
                      currentHash === item.href
                        ? 'border-l border-solid border-current font-semibold'
                        : 'font-normal',
    ...
    <div class="z-10 hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col">
      <div
        class="flex min-h-0 flex-1 flex-col shadow-[0px_0px_25px_0px_rgba(0,0,0,0.2)]"
        :style="{ backgroundColor: backgroundColor }"
      >
            ...
            <a
              ...
              :class="[
                currentHash === item.href
                  ? 'border-l border-solid border-current font-semibold'
                  : 'font-normal',
                'flex px-2 py-2 text-sm focus:outline-none',
              ]"
              v-text="item.name"
            />
          </nav>
    ...
    <div class="flex flex-1 flex-col md:pl-64">
      ...
      >
        <button
          type="button"
          class="-ml-0.5 -mt-0.5 inline-flex h-12 w-12 items-center justify-center rounded-md text-neutral-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-primary-500 hover:text-neutral-900"
