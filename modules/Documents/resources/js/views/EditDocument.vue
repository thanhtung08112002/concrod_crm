        ...
        <div class="flex items-center space-x-2">
          ...
          >
            <IDropdownButtonGroup
              ...
              "
              :loading="form.busy || syncingAssociations"
          ...
          >
            <template #actions>
              <div class="inline-block">
                ...
                >
                  <template #after-record="{ record, isSelected, isSearching, title }">
                    <span
                      v-if="record.is_primary_associated && isSelected && !isSearching"
...
const { brandsByName: brands, brandsAreBeingFetched } = useBrands()
...
/**
 * Sync the document associations
 *
 * @param  {Object} data
 *
 * @return {Void}
...
function syncAssociations(data) {
  ...
  Innoclapps.request()
    .post(`associations/documents/${document.value.id}`, data)
    .then(({ data }) => {
