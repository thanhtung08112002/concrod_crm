  ...
  >
    <div class="flex items-center">
      <IButton
        ...
        :disabled="
          !recordForm.isDirty || recordForm.busy || $gate.denies('update', deal)
        "
  ...
  <form @submit.prevent="update" novalidate="true">
    ...
    >
      ...
      >
        ...
        <FieldsGenerator
          v-if="componentReady"
          :class="['overflow-y-auto p-6', { 'h-56': !fieldsHeight }]"
          resizeable
...
const fieldsHeight = ref(Innoclapps.config('deal_fields_height'))
...
defineExpose({ fields, setFormValues })
</script>
