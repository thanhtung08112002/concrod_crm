    ...
    <div v-show="!showEmptyState && initialDataLoaded">
      ...
      <ICard no-body :overlay="isLoading">
        <div
          ...
          class="fixed left-auto right-1 z-50 w-full max-w-xs rounded-md border border-neutral-600 bg-neutral-800 py-5 px-6 shadow-lg shadow-primary-400/40 dark:shadow-primary-900/40 md:left-80 md:right-auto md:max-w-md"
        ...
        >
          <div class="flex flex-col md:flex-row md:items-center">
            ...
            <div class="mt-3 w-full md:mt-0 md:w-68">
              <ActionSelect
                ref="actionsRef"
                size="sm"
                view="index"
